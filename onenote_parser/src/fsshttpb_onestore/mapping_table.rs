...
impl crate::onestore::mapping_table::MappingTable for MappingTable {
...
mod tests {
    use crate::{
        onestore::mapping_table::MappingTable,
        shared::{cell_id::CellId, compact_id::CompactId, exguid::ExGuid, guid::Guid},
        utils::reader::Reader,
    };
    ...
    fn test_single_entry_fallbacks_to_only_value() {
        ...
        let table = super::MappingTable::from_entries(
